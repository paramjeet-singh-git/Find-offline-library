    ...
    <div>
      ...
      <div className="maincont1">
            ...
            <div className="sub-div">
              ...
              <h3 className='btm'><strong>Random</strong></h3>
              <p className='div-btm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut.😊</p>
              <button className="btn btn-dark " id='btns'><strong><Link to="/ran">Click here</Link></strong></button>
            </div>
      </div>
    </div>
  )
